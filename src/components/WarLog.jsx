    ...
    <div className="space-y-3">
      {validItems.map((war, i) => {
        ...
        return (
          <div
            key={i}
            className="bg-[#182030] border-2 border-slate-700/60 rounded-xl p-3 sm:p-4 flex flex-col md:flex-row md:flex-wrap items-stretch md:items-center justify-between gap-3 md:gap-4 hover:border-slate-500/80 transition-all duration-200 shadow-md overflow-hidden"
          >
            ...
            {/* War Meta Info */}
            <div className="w-full md:w-auto md:ml-auto flex items-center justify-center md:justify-end gap-2 sm:gap-3 text-[10px] sm:text-xs font-mono text-slate-400 shrink-0 border-t md:border-t-0 md:border-l border-slate-700/50 pt-2 md:pt-0 md:pl-4 py-0.5 overflow-hidden">
